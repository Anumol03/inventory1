...
urlpatterns = [
    ...
    path('purchases/<pk>/delete', views.PurchaseDeleteView.as_view(), name='delete-purchase'),
     path('get-stock-perprice/<int:stock_id>/', views.get_stock_perprice, name='get-stock-perprice'),
    ...
    # path('get-stock-perprice/<int:stock_id>/', views.get_stock_perprice, name='get_stock_perprice'),
